...
Summary(pl):	AGFL - generator parserów jêzyków naturalnych
Name:		agfl
Version:	2.3
Release:	0.1
...
%description -l pl
System generowania parserów AGFL dla jêzyków naturalnych generuje
wydajne parsery z gramatyk AGFL. Zawiera system leksykalny odpowiedni
dla du¿ych s³owników potrzebnych w prawdziwych aplikacjach NLP.
